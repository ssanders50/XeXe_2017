...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/blackhat/0.9.9-mlhled2/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/boost/1.63.0-mlhled2/include
...
boost_header_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/boost/1.63.0-mlhled2/include
...
boost_python_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/boost/1.63.0-mlhled2/include
...
ALL_TOOLS      += bz2lib
bz2lib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/bz2lib/1.0.6/include
bz2lib_EX_LIB := bz2
...
cascade_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/cascade/2.2.04-mlhled2/include
...
castor_header_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/castor/2.1.13.9/include /opt/cmssw/slc6_amd64_gcc530/external/castor/2.1.13.9/include/shift
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/cgal/4.2-mlhled2/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/charybdis/1.003-mlhled2/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := root_cxxdefaults f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/classlib/3.1.3-oenich/include
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/davix/0.6.4-mlhled2/include/davix
davix_EX_LIB := davix
davix_EX_USE := boost_system openssl libxml2

ALL_TOOLS      += db6
db6_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/db6/6.0.30/include
db6_EX_LIB := db

ALL_TOOLS      += dbs-client

ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/dcap/2.47.8-oenich/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += dpm
dpm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/dpm/1.8.0.1/include
dpm_EX_LIB := dpm
dpm_EX_LIBDIR := /opt/cmssw/slc6_amd64_gcc530/external/dpm/1.8.0.1/lib
dpm_EX_USE := root_cxxdefaults

ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/eigen/3.3.0-oenich2/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/evtgen/1.6.0-njopjo/include
evtgen_EX_LIB := EvtGen EvtGenExternal
evtgen_EX_USE := hepmc pythia8 tauolapp photospp

ALL_TOOLS      += expat
expat_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/expat/2.1.0/include
expat_EX_LIB := expat
expat_EX_USE := root_cxxdefaults

ALL_TOOLS      += fastjet-contrib-archive
fastjet-contrib-archive_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/fastjet-contrib/1.026/include
...
fastjet-contrib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/fastjet-contrib/1.026/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/fastjet/3.1.0/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet
fastjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/fftjet/1.5.0/include
fftjet_EX_LIB := fftjet
fftjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/fftw3/3.3.2/include
fftw3_EX_LIB := fftw3
fftw3_EX_USE := root_cxxdefaults

ALL_TOOLS      += file
file_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/file/5.18/include
file_EX_LIB := magic

ALL_TOOLS      += freetype
freetype_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/freetype/2.5.3-oenich/include
freetype_EX_LIB := freetype-cms
freetype_EX_USE := root_cxxdefaults

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/frontier_client/2.8.20-mlhled2/include
...
ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/gdbm/1.10/include
gdbm_EX_LIB := gdbm
...
geant4core_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/geant4/10.02.p02-mlhled2/include/Geant4
...
ALL_TOOLS      += giflib
giflib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/giflib/4.2.3-oenich/include
giflib_EX_LIB := gif
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/gmp-static/6.1.0-oenich/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
ALL_TOOLS      += gsl
gsl_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/gsl/2.2.1/include
gsl_EX_LIB := gsl gslcblas
gsl_EX_USE := root_cxxdefaults

ALL_TOOLS      += hdf5
hdf5_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/hdf5/1.8.17-oenich/include
hdf5_EX_LIB := hdf5

ALL_TOOLS      += hector
hector_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/hector/1.3.4_patch1-njopjo/include
...
hepmc_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/hepmc/2.06.07-oenich/include
hepmc_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/heppdt/3.03.00-oenich/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/herwig/6.521-mlhled2/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/herwigpp/7.0.4-njopjo/include
...
ALL_TOOLS      += ittnotify
ittnotify_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/ittnotify/16.06.18-oenich/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/jemalloc/4.5.0/include
...
ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/ktjet/1.06-mlhled2/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/lhapdf/6.1.6-mlhled2/include
lhapdf_EX_LIB := LHAPDF
lhapdf_EX_USE := yaml-cpp root_cxxdefaults

ALL_TOOLS      += libffi
libffi_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libffi/3.2.1/include
libffi_EX_LIB := ffi

ALL_TOOLS      += libhepml
libhepml_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libhepml/0.2.1/interface
libhepml_EX_LIB := hepml
libhepml_EX_USE := root_cxxdefaults

ALL_TOOLS      += libjpeg-turbo
libjpeg-turbo_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libjpeg-turbo/1.3.1/include
libjpeg-turbo_EX_LIB := jpeg turbojpeg
libjpeg-turbo_EX_USE := root_cxxdefaults

ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libpng/1.6.16-oenich/include
libpng_EX_LIB := png
libpng_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libtiff/4.0.3-oenich/include
libtiff_EX_LIB := tiff
libtiff_EX_USE := root_cxxdefaults libjpeg-turbo zlib

ALL_TOOLS      += libungif
libungif_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libungif/4.1.4/include
libungif_EX_LIB := ungif
libungif_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libuuid
libuuid_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libuuid/2.22.2/include
libuuid_EX_LIB := uuid
libuuid_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libxml2/2.9.1-oenich/include/libxml2
libxml2_EX_LIB := xml2
libxml2_EX_USE := root_cxxdefaults

ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/libxslt/1.1.28-mlhled2/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/llvm/4.0.0-njopjo/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/lwtnn/1.0-mlhled2/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mcdb
mcdb_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/mcdb/1.0.3/interface
mcdb_EX_LIB := mcdb
mcdb_EX_USE := root_cxxdefaults xerces-c

ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/mctester/1.25.0a-njopjo/include
mctester_EX_LIB := HEPEvent HepMCEvent MCTester
mctester_EX_USE := root_cxxdefaults root hepmc

ALL_TOOLS      += md5
md5_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/md5/1.0.0/include
md5_EX_LIB := cms-md5

ALL_TOOLS      += meschach
meschach_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/meschach/1.2.pCMS1/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/mpfr-static/3.1.3-oenich/include
mpfr_EX_LIB := mpfr

ALL_TOOLS      += openblas
openblas_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/OpenBLAS/0.2.19-mlhled2/include
...
ALL_TOOLS      += openssl
openssl_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/openssl/1.0.2d/include
openssl_EX_LIB := ssl crypto
openssl_EX_USE := root_cxxdefaults

ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/oracle/12.1.0.2.0/include
...
ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/pacparser/1.3.5/include
pacparser_EX_LIB := pacparser
pacparser_EX_USE := root_cxxdefaults

ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/pcre/8.37-oenich/include
pcre_EX_LIB := pcre
...
photos_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/photos/215.5/include
photos_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/photospp/3.61-oenich/include
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/protobuf/3.2.0/include
...
py2-numpy-c-api_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/py2-numpy/1.12.1-mlhled2/c-api/core/include
...
pythia6_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/pythia6/426/include
pythia6_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/pythia8/226/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/python/2.7.11-mlhled2/include/python2.7
python_EX_LIB := python2.7
python_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += qd
qd_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/qd/2.3.13/include
qd_EX_LIB := qd_f_main qdmod qd

ALL_TOOLS      += qt
qt_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/qt/4.8.7/include/QtOpenGL /opt/cmssw/slc6_amd64_gcc530/external/qt/4.8.7/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/qt/4.8.7/include/Qt3Support
...
qtdesigner_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/qt/4.8.7/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/rivet/2.5.2-njopjo/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/lcg/root/6.08.07/include
...
root_interface_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/lcg/root/6.08.07/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/lcg/root/6.08.07/include
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/sherpa/2.2.2-njopjo/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/sigcpp/2.6.2-oenich/include/sigc++-2.0
...
ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/starlight/r193-mlhled2/include
...
tauola_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/tauola/27.121.5/include
tauola_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/tauolapp/1.1.5-njopjo/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/tbb/2017_20161004oss/include
tbb_EX_LIB := tbb
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/thepeg/2.0.4-njopjo/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/tinyxml/2.5.3-mlhled2/include
tinyxml_EX_LIB := tinyxml

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/tkonlinesw/4.1.0-1-njopjo/include
...
toprex_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/toprex/4.23/include
toprex_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += utm
utm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/utm/utm_0.6.5/include
utm_EX_LIB := tmeventsetup tmtable tmxsd tmgrammar tmutil
utm_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/valgrind/3.12.0-oenich/include
...
vdt_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/cms/vdt/v0.3.2-oenich2/include
...
ALL_TOOLS      += xerces-c
xerces-c_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/xerces-c/3.1.3/include
xerces-c_EX_LIB := xerces-c
xerces-c_EX_USE := root_cxxdefaults

ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/xrootd/4.6.1.RC2/include/xrootd /opt/cmssw/slc6_amd64_gcc530/external/xrootd/4.6.1.RC2/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xz
xz_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/xz/5.2.1-oenich/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/yaml-cpp/0.5.1-mlhled2/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc530/external/yoda/1.6.5-njopjo/include
yoda_EX_LIB := YODA
