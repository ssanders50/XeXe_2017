...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/blackhat/0.9.9-fmblme/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/boost/1.63.0-fmblme/include
...
boost_header_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/boost/1.63.0-fmblme/include
...
boost_python_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/boost/1.63.0-fmblme/include
...
ALL_TOOLS      += bz2lib
bz2lib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/bz2lib/1.0.6/include
bz2lib_EX_LIB := bz2
...
cascade_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/cascade/2.2.04-fmblme/include
...
castor_header_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/castor/2.1.13.9/include /opt/cmssw/slc6_amd64_gcc630/external/castor/2.1.13.9/include/shift
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/cgal/4.2-fmblme/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/charybdis/1.003-fmblme/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := root_cxxdefaults f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/classlib/3.1.3-oenich/include
...
cuda-stubs_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/cuda/9.0.176-fmblme2/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /opt/cmssw/slc6_amd64_gcc630/external/cuda/9.0.176-fmblme2/lib64/stubs
cuda-stubs_EX_FLAGS_SKIP_TOOL_SYMLINKS  := 1

ALL_TOOLS      += cuda
cuda_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/cuda/9.0.176-fmblme2/include
...
ALL_TOOLS      += curl
curl_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/curl/7.52.1/include
curl_EX_LIB := curl
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/davix/0.6.4-fmblme/include/davix
davix_EX_LIB := davix
davix_EX_USE := boost_system openssl libxml2

ALL_TOOLS      += db6
db6_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/db6/6.0.30/include
db6_EX_LIB := db

ALL_TOOLS      += dbs-client

ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/dcap/2.47.8-oenich/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += dpm
dpm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/dpm/1.8.0.1/include
dpm_EX_LIB := dpm
dpm_EX_LIBDIR := /opt/cmssw/slc6_amd64_gcc630/external/dpm/1.8.0.1/lib
dpm_EX_USE := root_cxxdefaults

ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/eigen/f3a22f35b044/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/evtgen/1.6.0-fmblme2/include
evtgen_EX_LIB := EvtGen EvtGenExternal
evtgen_EX_USE := hepmc pythia8 tauolapp photospp

ALL_TOOLS      += expat
expat_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/expat/2.1.0/include
expat_EX_LIB := expat
expat_EX_USE := root_cxxdefaults

ALL_TOOLS      += fastjet-contrib-archive
fastjet-contrib-archive_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/fastjet-contrib/1.026/include
...
fastjet-contrib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/fastjet-contrib/1.026/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/fastjet/3.1.0/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet
fastjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/fftjet/1.5.0/include
fftjet_EX_LIB := fftjet
fftjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/fftw3/3.3.2/include
fftw3_EX_LIB := fftw3
fftw3_EX_USE := root_cxxdefaults

ALL_TOOLS      += freetype
freetype_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/freetype/2.5.3-oenich/include
freetype_EX_LIB := freetype-cms
freetype_EX_USE := root_cxxdefaults

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/frontier_client/2.8.20-fmblme/include
frontier_client_EX_LIB := frontier_client
frontier_client_EX_USE := root_cxxdefaults zlib openssl expat python

ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/gbl/V02-01-03-fmblme/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen
...
ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/gdbm/1.10/include
gdbm_EX_LIB := gdbm
...
geant4core_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/geant4/10.02.p02-fmblme3/include/Geant4
...
ALL_TOOLS      += giflib
giflib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/giflib/4.2.3-oenich/include
giflib_EX_LIB := gif
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/gmp-static/6.1.0-oenich/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
ALL_TOOLS      += gsl
gsl_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/gsl/2.2.1/include
gsl_EX_LIB := gsl gslcblas
gsl_EX_USE := root_cxxdefaults

ALL_TOOLS      += hdf5
hdf5_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/hdf5/1.8.17-oenich/include
hdf5_EX_LIB := hdf5

ALL_TOOLS      += hector
hector_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/hector/1.3.4_patch1-fmblme3/include
...
hepmc_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/hepmc/2.06.07-oenich/include
hepmc_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/heppdt/3.03.00-fmblme2/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/herwig/6.521-fmblme/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/herwigpp/2.7.1-fmblme/include
...
ALL_TOOLS      += ittnotify
ittnotify_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/ittnotify/16.06.18-fmblme/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/jemalloc/4.5.0/include
...
jimmy_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/jimmy/4.2-fmblme/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/ktjet/1.06-fmblme/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/lhapdf/6.2.1-fmblme/include
lhapdf_EX_LIB := LHAPDF
lhapdf_EX_USE := yaml-cpp root_cxxdefaults

ALL_TOOLS      += libffi
libffi_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libffi/3.2.1/include
libffi_EX_LIB := ffi

ALL_TOOLS      += libhepml
libhepml_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libhepml/0.2.1/interface
libhepml_EX_LIB := hepml
libhepml_EX_USE := root_cxxdefaults

ALL_TOOLS      += libjpeg-turbo
libjpeg-turbo_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libjpeg-turbo/1.3.1/include
libjpeg-turbo_EX_LIB := jpeg turbojpeg
libjpeg-turbo_EX_USE := root_cxxdefaults

ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libpng/1.6.16-oenich/include
libpng_EX_LIB := png
libpng_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libtiff/4.0.3-oenich/include
libtiff_EX_LIB := tiff
libtiff_EX_USE := root_cxxdefaults libjpeg-turbo zlib

ALL_TOOLS      += libungif
libungif_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libungif/4.1.4/include
libungif_EX_LIB := ungif
libungif_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libuuid
libuuid_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libuuid/2.22.2/include
libuuid_EX_LIB := uuid
libuuid_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libxml2/2.9.1-oenich/include/libxml2
libxml2_EX_LIB := xml2
libxml2_EX_USE := root_cxxdefaults

ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/libxslt/1.1.28-fmblme/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/llvm/4.0.1/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/lwtnn/1.0-fmblme2/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mcdb
mcdb_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/mcdb/1.0.3/interface
mcdb_EX_LIB := mcdb
mcdb_EX_USE := root_cxxdefaults xerces-c

ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/mctester/1.25.0a-fmblme3/include
mctester_EX_LIB := HEPEvent HepMCEvent MCTester
mctester_EX_USE := root_cxxdefaults root hepmc

ALL_TOOLS      += md5
md5_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/md5/1.0.0/include
md5_EX_LIB := cms-md5

ALL_TOOLS      += meschach
meschach_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/meschach/1.2.pCMS1/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/mpfr-static/3.1.3-oenich/include
mpfr_EX_LIB := mpfr

ALL_TOOLS      += openblas
openblas_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/OpenBLAS/0.2.19-mlhled2/include
...
ALL_TOOLS      += openmpi
openmpi_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/openmpi/2.1.2rc4/include
openmpi_EX_LIB := mpi mpi_cxx

ALL_TOOLS      += openssl
openssl_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/openssl/1.0.2d/include
openssl_EX_LIB := ssl crypto
openssl_EX_USE := root_cxxdefaults

ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/oracle/12.1.0.2.0/include
...
ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/pacparser/1.3.5/include
pacparser_EX_LIB := pacparser
pacparser_EX_USE := root_cxxdefaults

ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/pcre/8.37-oenich/include
pcre_EX_LIB := pcre
...
photos_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/photos/215.5/include
photos_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/photospp/3.61-oenich/include
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/protobuf/3.4.0-fmblme/include
...
py2-numpy-c-api_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/py2-numpy/1.12.1-fmblme/c-api/core/include
...
pythia6_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/pythia6/426/include
pythia6_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/pythia8/230/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/python/2.7.11-fmblme/include/python2.7
python_EX_LIB := python2.7
python_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += qd
qd_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/qd/2.3.13/include
qd_EX_LIB := qd_f_main qdmod qd

ALL_TOOLS      += qt
qt_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/QtOpenGL /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/Qt3Support
qt3support_EX_LIB := Qt3Support
qt3support_EX_USE := root_cxxdefaults qtbase
qt3support_EX_FLAGS_CPPDEFINES  := -DQT3_SUPPORT

ALL_TOOLS      += qtbase
qtbase_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/Qt /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/QtCore /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/QtXml
...
qtdesigner_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/qt/4.8.7/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/rivet/2.5.4/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/lcg/root/6.10.08/include
...
root_interface_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/lcg/root/6.10.08/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/lcg/root/6.10.08/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /home/sanders/XeXe_2017/CMSSW_9_4_2/src /home/sanders/XeXe_2017/CMSSW_9_4_2/include/LCG /opt/cmssw/slc6_amd64_gcc630/cms/cmssw/CMSSW_9_4_2/src /opt/cmssw/slc6_amd64_gcc630/cms/cmssw/CMSSW_9_4_2/include/LCG
self_EX_LIBDIR := /home/sanders/XeXe_2017/CMSSW_9_4_2/lib/slc6_amd64_gcc630 /home/sanders/XeXe_2017/CMSSW_9_4_2/external/slc6_amd64_gcc630/lib /opt/cmssw/slc6_amd64_gcc630/cms/cmssw/CMSSW_9_4_2/lib/slc6_amd64_gcc630 /opt/cmssw/slc6_amd64_gcc630/cms/cmssw/CMSSW_9_4_2/external/slc6_amd64_gcc630/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/sherpa/2.2.4-fmblme2/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/sigcpp/2.6.2-oenich/include/sigc++-2.0
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/sqlite/3.16.2/include
sqlite_EX_LIB := sqlite3
sqlite_EX_USE := root_cxxdefaults

ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/starlight/r193-fmblme/include
...
tauola_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tauola/27.121.5/include
tauola_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tauolapp/1.1.5-fmblme2/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tbb/2018/include
tbb_EX_LIB := tbb
...
tensorflow-c_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tensorflow-c/1.1.0-fmblme3/include
tensorflow-c_EX_LIB := tensorflow

ALL_TOOLS      += tensorflow-cc
tensorflow-cc_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tensorflow-cc/1.3.0-fmblme/tensorflow_cc/include
tensorflow-cc_EX_LIB := tensorflow_cc
tensorflow-cc_EX_USE := tensorflow-c eigen protobuf

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/thepeg/1.9.2p1-fmblme/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tinyxml/2.5.3-fmblme/include
tinyxml_EX_LIB := tinyxml

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/tkonlinesw/4.1.0-1-fmblme3/include
...
toprex_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/toprex/4.23/include
toprex_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += utm
utm_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/utm/utm_0.6.5-fmblme/include
utm_EX_LIB := tmeventsetup tmtable tmxsd tmgrammar tmutil
utm_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/valgrind/3.12.0-oenich/include
...
vdt_headers_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/cms/vdt/0.3.9/include
vdt_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += vincia
vincia_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/vincia/2.2.01-fmblme/include
...
ALL_TOOLS      += xerces-c
xerces-c_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/xerces-c/3.1.3/include
xerces-c_EX_LIB := xerces-c
xerces-c_EX_USE := root_cxxdefaults

ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/xrootd/4.6.1-fmblme/include/xrootd /opt/cmssw/slc6_amd64_gcc630/external/xrootd/4.6.1-fmblme/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xz
xz_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/xz/5.2.2-oenich/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/yaml-cpp/0.5.1-fmblme/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/yoda/1.6.7/include
yoda_EX_LIB := YODA
yoda_EX_USE := root_cxxdefaults

ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /opt/cmssw/slc6_amd64_gcc630/external/zlib-x86_64/1.2.11/include
zlib_EX_LIB := z
